...
const Usuarios = () => {
    ...
    // Usuarios de prueba (después los vamos a traer del backend)
                    ...
                    <tbody>
                        {users.map((user) => (
                            ...
                            >
                                ...
                                <td className="px-4 py-2 text-left">{user.surname}</td>
                ...
                <div className="fixed inset-0 bg-black/60 flex items-center justify-center z-50">
                    <div className="bg-gray-900 w-full max-w-md rounded-2xl shadow-2xl border border-gray-700 p-6 animate-fadeIn">
                        ...
                        <div className="flex justify-end gap-4 mt-6">
                            ...
                            <button onClick={() => console.log("Crear usuario con rol:", rol)}
